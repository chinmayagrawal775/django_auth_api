...
class UserRegistrationView(APIView):
    ...
    def post(self, request, format=None):
        ...
        return Response({'msg':'User Registered', 'token':token}, status=status.HTTP_201_CREATED)
...
class SendPasswordChangeEmailView(APIView):
    ...
    def post(self, request, format=None):
        ...
        serializer.is_valid(raise_exception=True)
        return Response({'msg':'Password Change Link Email Send'}, status=status.HTTP_201_CREATED)
